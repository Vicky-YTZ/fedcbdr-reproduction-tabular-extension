...
from data import (
    load_cifar10,
    get_task_datasets,
    split_task_dataset_among_clients,
    get_dataloader,
)
...
def train_task(
    ...
    client_datasets = split_task_dataset_among_clients(task_train_dataset, NUM_CLIENTS)
...
def main():
    ...
    # 为 Task0 重新切 client datasets，供 exact GDR 使用
    task0_client_datasets = split_task_dataset_among_clients(
        train_task_datasets[0],
        NUM_CLIENTS,
    )
    ...
    # 为 Task1 重新切 client datasets，供 exact GDR 使用
    task1_client_datasets = split_task_dataset_among_clients(
        train_task_datasets[1],
        NUM_CLIENTS,
    )
